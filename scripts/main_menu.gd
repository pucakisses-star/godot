...
## The front door: the two web-game GIFs (the smith at his anvil, the
## armored dwarf by the forge) play side by side behind the framed Dwarf
## Hold panel - frames pre-baked into 640x480 sprite sheets, 5 per row,
## advanced here by hand. Start forges a new world; Load Game opens the
## slot browser - every save listed with its character, world, day and

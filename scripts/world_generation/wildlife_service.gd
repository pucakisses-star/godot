...
const SPECIES: Array[Dictionary] = [
	...
	{"name": "Lizardman Chieftain", "slot": 5, "tier": 1, "biomes": ["grass", "forest", "marsh"],
	...
	{"name": "Orc Warlord", "slot": 7, "tier": 2, "biomes": ["grass", "forest", "sand"],
	...
	{"name": "Sand Reaver", "slot": 7, "tier": 2, "biomes": ["sand"],
	...
	{"name": "Deep Troll", "slot": 7, "tier": 2, "biomes": ["cave"],

...
const ITEM_DEFS := {
	...
	"Copper Helm": {"icon": 48, "sheet": 4, "flavor": "Keeps the rain and the regrets off."},
	"Iron Helm": {"icon": 49, "sheet": 4, "flavor": "Dents so your skull doesn't."},
	"Gold Helm": {"icon": 50, "sheet": 4, "flavor": "Heavy is the head that wears the bullion."},
	"Starmetal Helm": {"icon": 51, "sheet": 4, "flavor": "Thoughts feel quieter under sky-iron."},
	"Copper Greaves": {"icon": 52, "sheet": 4, "flavor": "Shin-deep in trouble, and ready for it."},
	"Iron Greaves": {"icon": 53, "sheet": 4, "flavor": "March-proof and bramble-blind."},
	"Gold Greaves": {"icon": 54, "sheet": 4, "flavor": "Wading through danger, expensively."},
	"Starmetal Greaves": {"icon": 55, "sheet": 4, "flavor": "Light as dusk on the legs."},
	"Copper Sabatons": {"icon": 56, "sheet": 4, "flavor": "Every step rings a little."},
	"Iron Sabatons": {"icon": 57, "sheet": 4, "flavor": "Kick down what argues."},
	"Gold Sabatons": {"icon": 58, "sheet": 4, "flavor": "Gilded toes, unbroken stride."},
	"Starmetal Sabatons": {"icon": 59, "sheet": 4, "flavor": "They barely print the snow."},

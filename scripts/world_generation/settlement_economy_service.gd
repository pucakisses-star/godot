...
const ITEM_VALUES := {
	...
	"Gold Nugget": 14, "Gem Shard": 16, "Iron Ingot": 8, "Leather Strap": 2,
	...
	"Grilled Fish": 6, "Mushroom Skewer": 5, "Hearty Stew": 12,
...
const SHOP_STOCK_POOLS := {
	...
	"tavern": ["Ale Keg", "Grilled Fish", "Hearty Stew", "Loaf of Bread", "Wheel of Cheese"],
	...
	"market_stall": ["Loaf of Bread", "Wheel of Cheese", "Skein of Wool", "Bolt of Cloth", "Wax Candles", "Dried Fish", "Jar of Honey"],
	"smithy": ["Iron Ingot", "Iron Horseshoes", "Miner's Pickaxe", "Stone Hammer", "Mason's Chisel", "Sledgehammer"],
	"forge": ["Iron Ingot", "Miner's Pickaxe", "Steel Pickaxe", "Stone Hammer", "Geologist's Hammer", "Sledgehammer", "Mason's Chisel"],
	...
	"apothecary": ["Mushrooms", "Glowcap", "Spore Dust", "Frostcap", "Violet Veil", "Jar of Honey"],

...
const TOWN_TILE_ATLAS := {
	...
	"water_grass_edge_n": Vector2i(0, 30),
	"water_grass_edge_s": Vector2i(1, 30),
	"water_grass_edge_w": Vector2i(2, 30),
	"water_grass_edge_e": Vector2i(3, 30),
	"water_grass_edge_nw": Vector2i(4, 30),
	"water_grass_edge_ne": Vector2i(5, 30),
	"water_grass_edge_sw": Vector2i(6, 30),
	"water_grass_edge_se": Vector2i(7, 30),
	"water_grass_in_nw": Vector2i(8, 30),
	"water_grass_in_ne": Vector2i(9, 30),
	"water_grass_in_sw": Vector2i(10, 30),
	"water_grass_in_se": Vector2i(11, 30),
	"water_grass_edge_ns": Vector2i(12, 30),
	"water_grass_edge_we": Vector2i(13, 30),
	"water_grass_tip_n": Vector2i(14, 30),
	"water_grass_tip_s": Vector2i(15, 30),
	"water_grass_tip_w": Vector2i(16, 30),
	"water_grass_tip_e": Vector2i(17, 30),
	"water_grass_island": Vector2i(18, 30),
	"water_sand_edge_n": Vector2i(0, 31),
	"water_sand_edge_s": Vector2i(1, 31),
	"water_sand_edge_w": Vector2i(2, 31),
	"water_sand_edge_e": Vector2i(3, 31),
	"water_sand_edge_nw": Vector2i(4, 31),
	"water_sand_edge_ne": Vector2i(5, 31),
	"water_sand_edge_sw": Vector2i(6, 31),
	"water_sand_edge_se": Vector2i(7, 31),
	"water_sand_in_nw": Vector2i(8, 31),
	"water_sand_in_ne": Vector2i(9, 31),
	"water_sand_in_sw": Vector2i(10, 31),
	"water_sand_in_se": Vector2i(11, 31),
	"water_sand_edge_ns": Vector2i(12, 31),
	"water_sand_edge_we": Vector2i(13, 31),
	"water_sand_tip_n": Vector2i(14, 31),
	"water_sand_tip_s": Vector2i(15, 31),
	"water_sand_tip_w": Vector2i(16, 31),
	"water_sand_tip_e": Vector2i(17, 31),
	"water_sand_island": Vector2i(18, 31),
	...
	"water_snow_edge_n": Vector2i(0, 35),
	"water_snow_edge_s": Vector2i(1, 35),
	"water_snow_edge_w": Vector2i(2, 35),
	"water_snow_edge_e": Vector2i(3, 35),
	"water_snow_edge_nw": Vector2i(4, 35),
	"water_snow_edge_ne": Vector2i(5, 35),
	"water_snow_edge_sw": Vector2i(6, 35),
	"water_snow_edge_se": Vector2i(7, 35),
	"water_snow_in_nw": Vector2i(8, 35),
	"water_snow_in_ne": Vector2i(9, 35),
	"water_snow_in_sw": Vector2i(10, 35),
	"water_snow_in_se": Vector2i(11, 35),
	"water_snow_edge_ns": Vector2i(12, 35),
	"water_snow_edge_we": Vector2i(13, 35),
	"water_snow_tip_n": Vector2i(14, 35),
	"water_snow_tip_s": Vector2i(15, 35),
	"water_snow_tip_w": Vector2i(16, 35),
	"water_snow_tip_e": Vector2i(17, 35),
	"water_snow_island": Vector2i(18, 35),
